...
if( $_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            do {
            	if(empty($Name) || empty($Address) || empty($PhoneNumber) || empty($Password)){
            		$Error = "All Fields Required";
            		break;
            	}

            $sql = "INSERT INTO pharmacies (Name,Address,PhoneNumber,Password) VALUES ('$Name','$Address','$PhoneNumber','$Password')";
