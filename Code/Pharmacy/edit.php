...
if ($_SERVER['REQUEST_METHOD'] == 'GET'){
	...
	$sql = "SELECT * FROM pharmacies WHERE PharmacyID=$ID";
    ...
    do {
    	if(empty($ID) || empty($Name) || empty($Address) || empty($PhoneNumber) || empty($Password)){
    	$Error = "All Fields Required";
    	break;
    	}
            	$sql = "UPDATE pharmacies ". "SET Name = '$Name', 
