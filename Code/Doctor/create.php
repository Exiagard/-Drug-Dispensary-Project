...
if( $_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            do {
            	if(empty($doctorssn) || empty($first_name) || empty($last_name) || empty($speciality) || empty($YOE) || empty($Password)){
            		$Error = "All Fields Required";
            		break;
            	}

            $sql = "INSERT INTO doctors (DoctorSSN,FirstName,LastName,Speciality,YOE,Password) VALUES ('$doctorssn','$first_name','$last_name','$speciality','$YOE','$Password')";
